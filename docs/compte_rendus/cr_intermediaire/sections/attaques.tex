...
\end{algorithmic}
\end{algorithm}
\todo{Peut etre réunir l'algorithme à la meme page que le titre}
...
Cette stratégie consiste donc à bloquer les liens les plus importants en les triant par centralité intermédiaire décroissante.
